...
public class JWTUtil {
    ...
    public String createJwt(String tokenType, Long memberId,String name, String email, String profile_image, String role, Long expiredMs) {
        ...
        return Jwts.builder()
                ...
                .claim("name", name)
                .claim("email", email)
                .claim("profile_image", profile_image)
                .claim("role", role)
